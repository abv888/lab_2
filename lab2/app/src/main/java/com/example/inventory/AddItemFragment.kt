...
class AddItemFragment : Fragment() {
    ...
    /* Метод для добавлении товара в БД */
    fun addNewItem() {
        if (isEntryValid()) {
    ...
    /* Метод для изменения товара в БД */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /* Если id есть, то надо загрузить данные в поля */
        if (id > 0) {
            ...
            /* Если поле есть в "реестре", то заполняем поля данными по умолчанию */
